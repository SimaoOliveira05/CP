...
Tenha-se atenção que o índice \ensuremath{\Varid{n}} representa o número de iterações já realizadas, começando em \ensuremath{\Varid{n}\mathrel{=}\mathrm{0}},
que corresponde ao primeiro termo da série.

\subsubsection*{Descoberta do numerador por recursividade mútua (\ensuremath{\Varid{h}})}
...
\subsubsection*{Descoberta do denominador por recursividade mútua (\ensuremath{\Varid{k}}, 2ª iteração)}
...
Para \ensuremath{\Varid{h}} e \ensuremath{\Varid{k}}, o índice \ensuremath{\Varid{n}} começa em \ensuremath{\mathrm{1}}, pois estas funções representam o numerador e denominador do termo \ensuremath{\Varid{n}} da série,
não do índice de iterações como em \ensuremath{\Varid{s}}.

\subsubsection*{Descoberta do denominador por recursividade mútua (\ensuremath{\Varid{j}}, 3ª iteração)}
...
\subsubsection*{Descoberta do denominador por recursividade mútua (\ensuremath{\Varid{m}}, 4ª iteração)}
...
Para \ensuremath{\Varid{j}} e \ensuremath{\Varid{m}}, o índice \ensuremath{\Varid{n}} começa em \ensuremath{\mathrm{0}}, tendo um significado puramente matemático. Na realidade,
estas funções têm um caráter auxiliar, tendo um índice sincronizado para gerar o termo de índice \ensuremath{\Varid{n}\mathbin{+}\mathrm{1}}.
...
A definição recursiva direta de \ensuremath{\Varid{sinh}\;\Varid{x}\;\Varid{n}} é ineficiente devido ao cálculo repetido
...
de ambas as implementações para um valor fixo de \ensuremath{\Varid{x}} e um número elevado de termos \ensuremath{\Varid{n}}.

Dada a definiçao direta de \ensuremath{\Varid{sinh\char95 direct}}:
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{sinh\char95 direct}\mathbin{::}\Conid{Floating}\;\Varid{a}\Rightarrow \Varid{a}\to \Conid{Int}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{sinh\char95 direct}\;\Varid{x}\;\mathrm{0}\mathrel{=}\Varid{x}{}\<[E]%
\\
\>[B]{}\Varid{sinh\char95 direct}\;\Varid{x}\;\Varid{n}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{let}\;\Varid{exponent}\mathrel{=}\mathrm{2}\mathbin{*}(\Varid{n}\mathbin{-}\mathrm{1})\mathbin{+}\mathrm{1}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{numerador}\mathrel{=}\Varid{x}\mathbin{\uparrow}\Varid{exponent}{}\<[E]%
\\
\>[5]{}\hsindent{4}{}\<[9]%
\>[9]{}\Varid{denominador}\mathrel{=}\Varid{fromIntegral}\;(\Varid{factorial}\;(\Varid{fromIntegral}\;\Varid{exponent})){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{in}\;\Varid{sinh\char95 direct}\;\Varid{x}\;(\Varid{n}\mathbin{-}\mathrm{1})\mathbin{+}\Varid{numerador}\mathbin{/}\Varid{denominador}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{factorial}\mathbin{::}\mathbb{Z}\to \mathbb{Z}{}\<[E]%
\\
\>[B]{}\Varid{factorial}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{factorial}\;\Varid{n}\mathrel{=}\Varid{n}\mathbin{*}\Varid{factorial}\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{measure}\mathbin{::}\Conid{String}\to \Conid{Double}\to \fun{IO}\;\Conid{Double}{}\<[E]%
\\
\>[B]{}\Varid{measure}\;\Varid{label}\;\Varid{expr}\mathrel{=}\mathbf{do}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{start}\leftarrow \Varid{getCPUTime}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{expr}\mathbin{`\Varid{deepseq}`}\Varid{return}\;(){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{end}\leftarrow \Varid{getCPUTime}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{let}\;\Varid{t}\mathrel{=}\Varid{fromIntegral}\;(\Varid{end}\mathbin{-}\Varid{start})\mathbin{/}\mathrm{1e12}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{putStrLn}\;(\Varid{label}\mathbin{+\!\!+}\text{\ttfamily \char34 ~levou~\char34}\mathbin{+\!\!+}\Varid{show}\;\Varid{t}\mathbin{+\!\!+}\text{\ttfamily \char34 ~s\char34}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{return}\;\Varid{expr}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{test1}\mathbin{::}\fun{IO}\;\Conid{Double}{}\<[E]%
\\
\>[B]{}\Varid{test1}\mathrel{=}\Varid{measure}\;\text{\ttfamily \char34 sinh\char95 direct\char34}\mathbin{\$}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{sum}\;[\mskip1.5mu \Varid{sinh\char95 direct}\;\mathrm{1.2}\;\mathrm{50}\mid \anonymous \leftarrow [\mskip1.5mu \mathrm{1}\mathinner{\ldotp\ldotp}\mathrm{1000}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{test2}\mathbin{::}\fun{IO}\;\Conid{Double}{}\<[E]%
\\
\>[B]{}\Varid{test2}\mathrel{=}\Varid{measure}\;\text{\ttfamily \char34 s\char34}\mathbin{\$}{}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\Varid{sum}\;[\mskip1.5mu \Varid{s}\;\mathrm{1.2}\;\mathrm{50}\mid \anonymous \leftarrow [\mskip1.5mu \mathrm{1}\mathinner{\ldotp\ldotp}\mathrm{1000}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Como era de esperar, o functor \ensuremath{\Conid{F}} é bastante similar ao functor das listas,
com a diferença de que não existe o caso vazio (\ensuremath{\Conid{Nil}}), visto que as streams são infinitas.

Pretende-se definir a função
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{fair\char95 merge}\mathbin{::}(\Conid{Stream}\;\Varid{a},\Conid{Stream}\;\Varid{a})\to \Conid{Stream}\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
onde \ensuremath{\Varid{g}\mathrel{=}\alt{g_{L}}{g_{R}}} com as componentes já derivadas anteriormente.
